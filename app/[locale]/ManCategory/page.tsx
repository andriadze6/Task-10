            ...
            <>
                <NewHeader></NewHeader>
                {
                    <div style={{display:"grid", gridTemplateColumns: "repeat(3,1fr)"}}>
                        {manProduct && manProduct.map((item,index) => {
                            return (
                            <div key={index} style={{ display: "flex", flexDirection: "column" }}>
                                <div className="Item">
                                    <div key={`product-${item.product_ID}`} style={{ position: "relative" }} className="cardImgDiv">
                                        <div>
                                        {item?.img &&
                                ...
                                <div style={{ textAlign: "center" }}>
                                    ...
                                    <div
                                        style={{display: "flex",gap: "20px",alignItems: "center",color: "#c1121f",}}>
