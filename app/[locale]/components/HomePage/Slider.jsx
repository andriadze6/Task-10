                ...
                <div style={{display:"flex", justifyContent:"space-between", padding:"10px"}}>
                    ...
                    <div style={{display:"flex", gap:"20px"}}>
                        ...
                        <div style={{display:"flex", gap:"10px"}}>
                            <button onClick={()=>{changeSlider(0)}} class="slider-Button">
                            ...
                            <button onClick={()=>{changeSlider(1)}} class="slider-Button">
                ...
                <div style={{display:"flex"}}>
                    {
                        NewArrival.map((item)=>{
                            return(
                                <div key={item.id} className="SliderItem" style={{flex: `0 0 calc(100% / ${3})`}}>
                                    <NewCard props={item}/>
                                </div>
                            )
                        })
