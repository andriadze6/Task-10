...
// export default function ProductPage({ params: number }) {
...
//                       {productData.dimensions.depth}(w/h/d)
//                     </p>
//                   </div>
//                   <div className="details-div">
//                     <h4>Rating</h4>
...
//               </div>
//               <div className="button-Div">
//                 <button id="toCheckout" className="button" type="submit">
//                   <FontAwesomeIcon
//                     icon={faShoppingCart}
